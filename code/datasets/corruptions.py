...
def frost(x, severity=1):
    ...
    import os
    filename = [f'./code/datasets/frost1.png', f'./code/datasets/frost2.png', 
                f'./code/datasets/frost3.png', f'./code/datasets/frost4.jpg', 
                f'./code/datasets/frost5.jpg', f'./code/datasets/frost6.jpg'][idx]
    
    frost = cv2.imread(f'{filename}')
